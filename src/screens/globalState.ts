...
export class GlobalState {
  ...
  get orderStatuses() {
    if (this.status.orderStatuses === null) {
      ...
      .toPromise()
      .then(result => {
        this.setOrderStatuses(result as unknown as CrmType[]);
      })
    }
  ...
  get productStatuses() {
    if (this.status.productStatuses === null) {
      ...
      .toPromise()
      .then(result => {
        this.setProductStatuses(result as unknown as CrmType[]);
      })
    }
  ...
  get deliveryTypes() {
    if (this.status.deliveryTypes === null) {
      ...
      .toPromise()
      .then(result => {
        this.setDeliveryTypes(result as unknown as CrmType[]);
      })
    }
